...
import "./PlasmicTextInput.css"; // plasmic-import: mC8H6YvKA7jj/css
  ...
  return (() => {
    const child$Props = {
      ...
      className: classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "TextInput__ariaInput__tZnHw",
        {
          TextInput__ariaInputflat_bottom__tZnHwpAwRz: hasVariant(
            $state,
            "flat",
            "bottom"
          ),
          TextInput__ariaInputflat_left__tZnHWs5KHg: hasVariant(
            $state,
            "flat",
            "left"
          ),
          TextInput__ariaInputflat_right__tZnHWyRd1Q: hasVariant(
            $state,
            "flat",
            "right"
          ),
          TextInput__ariaInputflat_top__tZnHwUsBNx: hasVariant(
            $state,
            "flat",
            "top"
          ),
          TextInput__ariaInputpadded_left__tZnHWiykBi: hasVariant(
            $state,
            "padded",
            "left"
          ),
          TextInput__ariaInputpadded_right__tZnHwdAyzf: hasVariant(
            $state,
            "padded",
            "right"
          ),
          TextInput__ariaInputtype_plain__tZnHwbnQi2: hasVariant(
            $state,
            "type",
            "plain"
          ),
          TextInput__ariaInputtype_soft__tZnHw7VPPq: hasVariant(
            $state,
            "type",
            "soft"
          )

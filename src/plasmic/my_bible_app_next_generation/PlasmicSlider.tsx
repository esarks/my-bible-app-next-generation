...
import "./PlasmicSlider.css"; // plasmic-import: d3zuxQJVh6QB/css
        ...
        >
          {$props.showLabel ? (
            <Label
              ...
              className={classNames("__wab_instance", "Slider__label__xkdUw")}
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
          ...
          {(() => {
            ...
            <BaseSliderOutput
              ...
              className={classNames(
                "__wab_instance",
                "Slider__ariaSliderOutput__zgNwa"
              )}
            >
              <React.Fragment>
      ...
      >
        ...
        >
          <BaseSliderTrack
            ...
            className={classNames(
              "__wab_instance",
              "Slider__ariaSliderTrack__j8Vm1"
            )}
            progressBar={
              $props.filled ? (
                <div

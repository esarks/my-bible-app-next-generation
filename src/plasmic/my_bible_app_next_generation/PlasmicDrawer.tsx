...
import "./PlasmicDrawer.css"; // plasmic-import: Lz2rVBqKrPRv/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Drawer__ariaDialogTrigger__o79Vu",
        {
          Drawer__ariaDialogTriggernoTrigger__o79VuEjKli: hasVariant(
            $state,
            "noTrigger",
            "noTrigger"
          )
      ...
      dialog={
        <BaseModal
          ...
          className={classNames("__wab_instance", "Drawer__ariaModal__quI3", {
            Drawer__ariaModalnoTrigger__quI3EjKli: hasVariant(
              $state,
              "noTrigger",
              "noTrigger"
            )
          ...
          modalOverlayClass={classNames({ pcls_8lDY5aA0s9Zo: true })}
        ...
        >
          <BaseDialog
            ...
            className={classNames(
              "__wab_instance",
              "Drawer__ariaDialog__xAd1H",
              {
                Drawer__ariaDialognoTrigger__xAd1HEjKli: hasVariant(
                  $state,
                  "noTrigger",
                  "noTrigger"
                )
            ...
            >
              ...
              <div
                ...
                className={classNames(
                  "plasmic_default__all",
                  "plasmic_default__div",
                  "Drawer__scrollableContent__zw9Wq"
                )}
              >
                {renderPlasmicSlot({
                  defaultContents: (

...
import "./PlasmicMenuPopover.css"; // plasmic-import: qzuX3pTXiwbo/css
    ...
    >
      {(() => {
        const child$Props = {
          className: classNames(
            "__wab_instance",
            "MenuPopover__ariaListBox__tt5Xl"
          ),
              ...
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuSection
                    className={classNames(
                      "__wab_instance",
                      "MenuPopover__menuSection__h7Co"
                    )}
                    items={
                      <React.Fragment>
                        <MenuItem

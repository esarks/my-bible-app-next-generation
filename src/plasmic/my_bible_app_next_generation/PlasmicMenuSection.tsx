...
import "./PlasmicMenuSection.css"; // plasmic-import: gaLdDYdQC1XP/css
      ...
      header={
        <div
          ...
          className={classNames(
            ...
            "MenuSection__freeBox__aFyrI"
          )}
        >
          {renderPlasmicSlot({
            defaultContents: "Section Header",
            value: args.header,
            className: classNames("MenuSection__slotTargetHeader__jaBom")
          })}
        </div>
      }

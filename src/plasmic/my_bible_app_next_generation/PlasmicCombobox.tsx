...
import "./PlasmicCombobox.css"; // plasmic-import: hMFViv7GZeka/css
  ...
  return (
    <BaseComboBox
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Combobox__ariaComboBox__bYv2T",
        {
          Combobox__ariaComboBoxtype_plain__bYv2TMlLiL: hasVariant(
            $state,
            "type",
            "plain"
          ),
          Combobox__ariaComboBoxtype_soft__bYv2TAhNaV: hasVariant(
            $state,
            "type",
            "soft"
          )
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "Combobox__label__gMxB")}
        >
          {renderPlasmicSlot({

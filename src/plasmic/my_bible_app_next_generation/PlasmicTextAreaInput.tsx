...
import "./PlasmicTextAreaInput.css"; // plasmic-import: D6FiH7xsZPV1/css
  ...
  return (() => {
    const child$Props = {
      ...
      className: classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "TextAreaInput__ariaTextArea___4VSsu",
        {
          TextAreaInput__ariaTextAreaflat_bottom___4VSsUvfGq: hasVariant(
            $state,
            "flat",
            "bottom"
          ),
          TextAreaInput__ariaTextAreaflat_left___4VSsu8UC9I: hasVariant(
            $state,
            "flat",
            "left"
          ),
          TextAreaInput__ariaTextAreaflat_right___4VSsuOhEi0: hasVariant(
            $state,
            "flat",
            "right"
          ),
          TextAreaInput__ariaTextAreaflat_top___4VSsUzwlbo: hasVariant(
            $state,
            "flat",
            "top"
          ),
          TextAreaInput__ariaTextAreapadded_left___4VSsUipV9G: hasVariant(
            $state,
            "padded",
            "left"
          ),
          TextAreaInput__ariaTextAreapadded_right___4VSsukm00D: hasVariant(
            $state,
            "padded",
            "right"
          ),
          TextAreaInput__ariaTextAreatype_plain___4VSsUuHfzt: hasVariant(
            $state,
            "type",
            "plain"
          ),
          TextAreaInput__ariaTextAreatype_soft___4VSsUouxl5: hasVariant(
            $state,
            "type",
            "soft"
          )

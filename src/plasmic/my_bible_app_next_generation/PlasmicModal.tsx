...
import "./PlasmicModal.css"; // plasmic-import: I_tEepmA34La/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Modal__ariaDialogTrigger__ays48",
        {
          Modal__ariaDialogTriggernoTrigger__ays48Mf8Gh: hasVariant(
            $state,
            "noTrigger",
            "noTrigger"
          )
      ...
      dialog={
        <BaseModal
          ...
          className={classNames("__wab_instance", "Modal__ariaModal__mKcA", {
            Modal__ariaModalnoTrigger__mKcAmf8Gh: hasVariant(
              $state,
              "noTrigger",
              "noTrigger"
            )
          ...
          modalOverlayClass={classNames({ pcls_uS3qBPLWpcpQ: true })}
        ...
        >
          <BaseDialog
            ...
            className={classNames(
              "__wab_instance",
              "Modal__ariaDialog__moSk8",
              {
                Modal__ariaDialognoTrigger__moSk8Mf8Gh: hasVariant(
                  $state,
                  "noTrigger",
                  "noTrigger"
                )
          ...
          >
            ...
            <div
              ...
              className={classNames(
                ...
                "Modal__scrollableContent__voBl5"
              )}
            >
              {renderPlasmicSlot({
                defaultContents: (

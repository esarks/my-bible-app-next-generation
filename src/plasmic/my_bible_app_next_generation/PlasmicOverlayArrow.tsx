...
import "./PlasmicOverlayArrow.css"; // plasmic-import: Y63mtqn2B6Aq/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: AuJ0j2MHl3zh/icon
  ...
  return (
    <BaseOverlayArrow
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "OverlayArrow__root__kZQr",
        {
          OverlayArrow__rootdark__kZQrKqwQ7: hasVariant($state, "dark", "dark")
        }
      )}
    ...
    >
      <TriangleFilledIcon
        ...
        className={classNames(
          ...
          "OverlayArrow__svg__cq33Q",
          {
            OverlayArrow__svgdark__cq33QKqwQ7: hasVariant(
              $state,
              "dark",
              "dark"
            )

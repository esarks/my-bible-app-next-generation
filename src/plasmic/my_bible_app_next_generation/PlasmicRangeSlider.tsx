...
import SliderThumb from "../../components/SliderThumb"; // plasmic-import: aa9XOKWcbA6W/component
...
import "./PlasmicRangeSlider.css"; // plasmic-import: 5ri_YqKTrc2w/css
  ...
  return (
    <BaseSlider
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "RangeSlider__ariaRangeSlider__eQeFz"
      )}
      defaultValue={[20, 50]}
    ...
    >
      ...
      >
        ...
        {$props.showOutputText ? (
          <BaseSliderOutput
            ...
            className={classNames(
              "__wab_instance",
              "RangeSlider__ariaSliderOutput__n6Obf"
            )}
          >
            <div
      ...
      >
        <div
          ...
          className={classNames(
            "plasmic_default__all",
            "plasmic_default__div",
            "RangeSlider__background__zgZcp"
          )}
        >
          <BaseSliderTrack
            ...
            className={classNames(
              "__wab_instance",
              "RangeSlider__ariaSliderTrack__jKohR"
            )}
            progressBar={
              $props.filled ? (
                <div
                  ...
                  className={classNames(
                    "plasmic_default__all",
                    "plasmic_default__div",
                    "RangeSlider__foreground__t9FRb"
                  )}
                />
              ) : null
            }
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <SliderThumb
                  className={classNames(
                    "__wab_instance",
                    "RangeSlider__sliderThumb__whfUw"
                  )}
                />
              ),
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames(
            "__wab_instance",
            "RangeSlider__description__iiOao"
          )}
        />
      ) : null}
    </BaseSlider>
